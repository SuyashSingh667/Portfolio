...
const STICKY_NOTES: StickyNoteItem[] = [
  {
    ...
    paperType: 1,
    rotation: -8,
    positionClass: "top-2 left-[1%] sm:left-[5%] md:left-[8%]",
  },
  {
    id: "note-2",
    title: "💡 Physics Fun",
    ...
    paperType: 2,
    rotation: 7,
    positionClass: "top-4 right-[1%] sm:right-[5%] md:right-[8%]",
  },
  {
    id: "note-3",
    title: "🚀 Full Stack",
    ...
    paperType: 3,
    rotation: -5,
    positionClass: "top-[36%] left-[-2%] sm:left-[2%] md:left-[5%] hidden sm:block",
  },
  {
    id: "note-4",
    title: "✨ 3D Depth",
    ...
    paperType: 4,
    rotation: 9,
    positionClass: "top-[40%] right-[-2%] sm:right-[2%] md:right-[5%] hidden sm:block",
  },
  {
    id: "note-5",
    title: "📄 Page Bounds",
    content: "Tossed paper balls land smoothly on the page floor.",
    paperType: 1,
    rotation: -4,
    positionClass: "bottom-10 left-[14%] md:left-[20%] hidden md:block",
  },
];

  ...
  useEffect(() => {
    ...
    const updateProgress = (now: number) => {
      ...
      if (progressRatio < 1) {
        ...
        setProgress(100);
        // Delay slightly at 100% before triggering exit transition
        setTimeout(() => {
          setIsVisible(false);
    ...
    >
      {isVisible && (
        <motion.div
          ...
          className="fixed inset-0 z-[99999] flex flex-col items-center justify-center bg-[#fafafa] text-zinc-900 select-none pointer-events-auto"

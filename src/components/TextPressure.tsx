...
// Simple debounce implementation with typed arguments
    ...
    const animate = () => {
      ...
      if (titleRef.current) {
        ...
        spansRef.current.forEach((span) => {
          ...
          const wdth = width ? Math.floor(getAttr(d, maxDist, 55, 150)) : 100;
        ...
        {chars.map((char, i) => (
          <span
            ...
            style={{
              ...
              color: (isMounted && !stroke) ? textColor : undefined,
            }}
          >
            {char === " " ? "\u00A0" : char}
          </span>

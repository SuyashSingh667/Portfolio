...
class ImageTrailVariant2 implements TrailVariant {
  container: HTMLElement;
  images: ImageItem[];
  imagesTotal: number;
  imgPosition = 0;
...
class ImageTrailVariant3 implements TrailVariant {
  container: HTMLElement;
  images: ImageItem[];
  imagesTotal: number;
  imgPosition = 0;
...
class ImageTrailVariant4 implements TrailVariant {
  container: HTMLElement;
  images: ImageItem[];
  imagesTotal: number;
  imgPosition = 0;
...
class ImageTrailVariant5 implements TrailVariant {
  container: HTMLElement;
  images: ImageItem[];
  imagesTotal: number;
  imgPosition = 0;
...
class ImageTrailVariant6 implements TrailVariant {
  container: HTMLElement;
  images: ImageItem[];
  imagesTotal: number;
  imgPosition = 0;
...
class ImageTrailVariant7 implements TrailVariant {
  container: HTMLElement;
  images: ImageItem[];
  imagesTotal: number;
  imgPosition = 0;
...
class ImageTrailVariant8 implements TrailVariant {
  container: HTMLElement;
  DOM: { el: HTMLElement };
  images: ImageItem[];
  imagesTotal: number;
